...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitGrammarDecl(ANTLRv4Parser::GrammarDeclContext *context) = 0;
    ...
    virtual antlrcpp::Any visitAction_(ANTLRv4Parser::Action_Context *context) = 0;
